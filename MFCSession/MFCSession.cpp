...
BEGIN_MESSAGE_MAP(CMFCSessionApp, CWinApp)
...
// 僅有的一個 CMFCSessionApp 物件

CMFCSessionApp theApp;


// CMFCSessionApp 初始設定

BOOL CMFCSessionApp::InitInstance()
{
