...
BEGIN_MESSAGE_MAP(CAOIRDPSessionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CAOIRDPSessionApp 建構

CAOIRDPSessionApp::CAOIRDPSessionApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CAOIRDPSessionApp 物件

CAOIRDPSessionApp theApp;


// CAOIRDPSessionApp 初始設定

BOOL CAOIRDPSessionApp::InitInstance()
{
